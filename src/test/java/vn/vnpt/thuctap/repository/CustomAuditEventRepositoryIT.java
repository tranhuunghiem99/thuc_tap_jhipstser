package vn.vnpt.thuctap.repository;

import vn.vnpt.thuctap.KhaosatApp;

import vn.vnpt.thuctap.config.Constants;
import vn.vnpt.thuctap.config.audit.AuditEventConverter;
import vn.vnpt.thuctap.domain.PersistentAuditEvent;
...
import static vn.vnpt.thuctap.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
